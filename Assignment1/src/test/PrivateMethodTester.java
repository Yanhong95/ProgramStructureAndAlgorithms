...
public class PrivateMethodTester {
    ...
    /**
     * Method to invoke a private method on the object of this test.PrivateMethodTester
     *
    ...
    /**
     * Method to invoke a private method on the object of this test.PrivateMethodTester but where we look for a method matching an explicit set of parameter classes.
     *
     * @param name       the name of the private method
