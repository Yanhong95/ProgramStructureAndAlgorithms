...
/**
 * This class implements a simple main.Benchmark utility for measuring the running time of algorithms.
...
public class Benchmark<T> {
    ...
    /**
     * Constructor for a main.Benchmark with option of specifying all three functions.
     *
    ...
    /**
     * Constructor for a main.Benchmark with only fRun and fPost Consumer parameters.
     *
     * @param fRun a Consumer function (i.e. a function of T => Void).
     *             Function fRun is the function whose timing you want to measure. For example, you might create a function which sorts an array.
     *             When you create a lambda defining fRun, you must return "null."
    ...
    /**
     * Constructor for a main.Benchmark where only the (timed) run function is specified.
     *
    ...
    private long doRun(T t, boolean warmup) {
        ...
        // for each invocation of run, run the given target function ten times to get the system
        // "warmed up" before you start the timing properly.
        if(warmup){
            for(int i=0;i<10;i++)
             fRun.accept(t1);
            return 0;
    ...
    /**
     * Everything below this point has to do with a particular example of running a main.Benchmark
    ...
    public static void main(String[] args) {
        ...
        // you should use the System.nanoTime method to get the clock time. This isn't guaranteed to be accurate
        // which is one of the reasons you should run the experiment several times for each value of n.
